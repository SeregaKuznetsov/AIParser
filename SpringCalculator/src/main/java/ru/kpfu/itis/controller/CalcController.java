...
public class CalcController {
    ...
    public String addUser(Model model) {
        ...
        // Эти действия делются наверху
//        model.addAttribute("firstOperand", calculator.getFirstOperand());
//        model.addAttribute("secondOperand", calculator.getSecondOperand());
//        model.addAttribute("mathAction", calculator.getMathAction());
        System.out.println(calculator.getFirstOperand());
        System.out.println("result" + calcService.getResult());
